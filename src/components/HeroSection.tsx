...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-red-50">
      ...
      <div className="absolute top-40 right-10 w-72 h-72 bg-red-400 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20 text-center">
        ...
        <div className="animate-fade-in">
          <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-red-200 mb-6 sm:mb-8">
            <Cherry className="w-4 h-4 text-red-600 mr-2" />
            <span className="text-xs sm:text-sm font-medium text-red-600">Premium Productivity Platform</span>
          </div>

          <h1 className="text-3xl sm:text-5xl md:text-7xl font-black mb-4 sm:mb-6 leading-tight">
            Transform Your
            <span className="block text-red-500">Workflow</span>
            Into Visual Magic
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16 px-4">
            <Button 
              size="lg" 
              className="bg-red-500 hover:bg-red-600 text-white text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-xl brutalist-shadow hover-lift group neo-brutal"
            >
              <Cherry className="mr-2 w-4 h-4 sm:w-5 sm:h-5" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 animate-slide-up px-4">
            <div className="bg-white/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-gray-200 hover-lift">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-100 rounded-xl flex items-center justify-center mb-3 sm:mb-4 mx-auto">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-gray-200 hover-lift" style={{animationDelay: '0.3s'}}>
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-red-100 rounded-xl flex items-center justify-center mb-3 sm:mb-4 mx-auto">
                <Cherry className="w-5 h-5 sm:w-6 sm:h-6 text-red-600" />
              </div>
